					...
					<div class="modal-body">
						<nav>
							<div class="nav nav-tabs" id="nav-tab-menu" role="tablist">
								...
								<a class="nav-item nav-link" id="nav-moph-refer-tab" data-toggle="tab" href="#nav-moph-refer" role="tab" aria-controls="nav-moph-refer" aria-selected="false">ใบ Refer (Moph Refer)</a>
