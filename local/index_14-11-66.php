...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" href="http://61.19.25.200/web/hy_ico.ico">
...
<script type="text/javascript">
	...
	function send_sms(hn,mobile){
		//console.log(mobile);
		$.ajax({
			url: 'http://61.19.25.200/otp/otp_check.php',
			type: "POST",
			//dataType: "json",
	...
	function showptservice(referout_no){
		...
		$.ajax({
				...
				url : "http://61.19.25.200/refer/thairefer/get_thairefer_rh12.php",
				type: "GET",
