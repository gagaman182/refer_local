					...
					<div class="tab-pane fade p-1" id="m-report" role="tabpanel" aria-labelledby="m-report-tab">
						<div class="row">
							<div class="col-md-12">
								<div class="panel  panel-primary">
									<div class="panel-heading">
										<h3 class="panel-title">จำนวนการส่งผู้ป่วยนัด Refer Online วันที่ <?php echo date('d-m-Y');?></h3>											
									</div>
									<div class="panel-body p-1">
										<!-- <div class="row">
											<div class="col-md-4">
												<div class="card border-success mb-3">
													<div class="card-header bg-transparent border-success p-2">ลงนัดในระบบ PMK</div>
													<div class="card-body p-2">
														<div class="row">
															<div class="col-md-6 text-success text-left font-weight-bold">
																<p class="font-weight-bold h1" id="appoint_pmk">20</p>
																<p class="font-weight-bold h6">ลงนัดใน PMK</p>
															</div>
															<div class="col-md-6 text-danger text-right">
																<p class="font-weight-bold h1" id="not_appoint_pmk">20</p>
																<p class="font-weight-bold h6">ไม่ลงนัดใน PMK</p>
															</div>
														</div>
													</div>
													<div class="card-footer bg-transparent border-success text-right p-2">
											...
											<div class="col-md-4">
												<div class="card border-success mb-3">
													<div class="card-header bg-transparent border-success p-2">ลงรับ Refer ในระบบ PMK</div>
													<div class="card-body p-2">
														<div class="row">
															<div class="col-md-6 text-success text-left font-weight-bold">
																<p class="font-weight-bold h1" id="refer_pmk">20</p>
																<p class="font-weight-bold h6">ลงรับ Referใน PMK</p>
															</div>
															<div class="col-md-6 text-danger text-right">
																<p class="font-weight-bold h1" id="not_refer_pmk">20</p>
																<p class="font-weight-bold h6">ไม่ลงรับ Referใน PMK</p>
															</div>
														</div>
													</div>
													<div class="card-footer bg-transparent border-success text-right p-2">
											...
											<div class="col-md-4">
												<div class="card border-success mb-3">
													<div class="card-header bg-transparent border-success p-2">ส่งบัตรในระบบ PMK</div>
													<div class="card-body p-2">
														<div class="row">
															<div class="col-md-6 text-success text-left font-weight-bold">
																<p class="font-weight-bold h1" id="visit_pmk">20</p>
																<p class="font-weight-bold h6">ส่งบัตรใน PMK</p>
															</div>
															<div class="col-md-6 text-danger text-right">
																<p class="font-weight-bold h1" id="not_visit_pmk">20</p>
																<p class="font-weight-bold h6">ไม่ส่งบัตรใน PMK</p>
															</div>
														</div>
													</div>
													<div class="card-footer bg-transparent border-success text-right p-2">
						...
						<!-- <div class="row">
							<div class="col-md-6">
								<div class="panel  panel-info">
									<div class="panel-heading">
										<h3 class="panel-title">% การใช้งานระบบนัดผู้ป่วย Refer</h3>											
									</div>
									<div class="panel-body p-1">
										<div id="total_percen" class="panel panel-default"></div>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="panel  panel-info">
									<div class="panel-heading">
										<h3 class="panel-title">% การใช้งานระบบนัดผู้ป่วย Refer แยกรายรพ.</h3>											
									</div>
									<div class="panel-body p-1">
										<div id="total" class="panel panel-default"></div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="panel  panel-info">
									<div class="panel-heading">
										<h3 class="panel-title">จำนวนผู้ป่วย Refer นัดรายวัน</h3>											
									</div>
									<div class="panel-body p-1">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="panel  panel-primary">
									<div class="panel-heading">
										<h3 class="panel-title">จำนวนผู้ป่วยนัด Refer ที่มาตรวจประจำวันที่ <?php echo date('d-m-Y');?></h3>											
									</div>
									<div class="panel-body p-1">
...
<script type="text/javascript">
	...
	$(document).ready(function() {		
		...
		getlookup();
		//auto_pushtext();
		$('#tbl_ptapp').bootstrapTable('refresh',{url : "get_appoint.php?q=app&pla=&app_status=0&date_app="+date_app});
	...
	$("#pla,#app_status,#referout_date").on('change',function(){		
		...
		var pla=$("#pla").val();
		var date_app=$("#referout_date").val();
		$('#tbl_ptapp').bootstrapTable('refresh',{url : "get_appoint.php?q=app&pla="+pla+"&app_status="+app_status+"&date_app="+date_app});
	...
	function showptservice(referout_no){
		...
		$.ajax({
				...
				success:function(data){
					//console.log('service thairefer= '+data[0].cc);
	...
	function total_place(){
		var options = {
			...
			title: {
				text: 'จำนวนการ Refer รายแผนก ตั้งแต่เดือน 07-2563'
			},
			subtitle: {
			...
			xAxis: {
				categories: [],	
					...
					formatter: function() {
						...
						var y=value[1];
						//console.log(m);
						//return '<a href="#" onclick=t('+m+');>'+this.value +'</a>'
						return '<p onclick=\'g_appline_d('+m+','+y+')\';>'+this.value+'</p>';
					}   
				}
			},
			yAxis: {
		...
		$.ajax({
        url: 'get_report_place.php',		
        success: function(json) {
			//console.log(json[0]);
			options.xAxis.categories = json[0];
			options.series=json[1];
	...
	function hosp_refer(){
		...
		$.getJSON('get_report_hosp.php', function(list) {
			console.log(list);
