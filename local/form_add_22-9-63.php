													...
													<div class="col-md-9">											
														...
														<div class="form-row">	
															<div class="col-md-3 mb-1">
																...
																<input required  type="text" class="form-control" name="who" id="who" placeholder="">
															</div>
															<div class="col-md-3 mb-1">
																<label for="who">นามสกุลผู้ติดต่อได้ *</label>
																<input required  type="text" class="form-control" name="who_lname" id="who_lname" placeholder="">
															</div>
															<div class="col-md-3 mb-1">
																<label for="who_contact">เกี่ยวข้องเป็น *</label>
																<input required  type="text" class="form-control" name="who_contact" id="who_contact" placeholder="">
															</div>	
															<div class="col-md-3 mb-1">
								...
								<div class="row">
									<div class="col-md-12">										
										<div class="panel  panel-primary">
											...
											<div class="panel-body p-1">
												<table id="tbl_diag" class="table" data-toggle="table" data-cache="false"  data-url="" data-show-export="false" data-pagination="false" data-row-style=""  data-locale="th-th">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="panel  panel-primary">
											...
											<div class="panel-body p-1">
												<table id="tbl_drug" class="table" data-toggle="table" data-cache="false" data-search="false" data-show-print="false" data-url="" data-show-export="false" data-pagination="false" data-row-style="" data-export-types="['excel']" data-locale="th-th">
													<thead class="thead-light">	
														<tr>
