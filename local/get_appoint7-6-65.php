	...
	if($_GET['q']=='new'){
		...
		while($rs=mysql_fetch_array($query)){
			...
			*/
			...
			if($rs['moph']=='04'){
				$a['moph']='<i class="fas fa-check-circle fa-2x text-success" title="มี App หมอพร้อม แล้ว"></i>';
			}elseif($rs['moph']=='05'){
				$a['moph']='<i class="fas fa-times-circle fa-2x text-danger" title="ไม่มี App หมอพร้อม"></i>';
			}else{
