<?php
	include("../config/conn_refer.php");
		...
		$sql="SELECT DISTINCT referout_no,hn,status_app,refer_appoint,visit_appoint,date_app,placecode_main FROM appoint INNER JOIN total_app ON appoint.placecode=total_app.placecode WHERE hn<>'' and (appoint.del_flag ='' or appoint.del_flag is NULL ) AND status_app is null AND date_format(date_app,'%d-%m-%Y')>=date_format(now(),'%d-%m-%Y')";
		...
		$sql="SELECT DISTINCT referout_no,hn,status_app,refer_appoint,visit_appoint,date_app,placecode_main FROM appoint INNER JOIN total_app ON appoint.placecode=total_app.placecode WHERE hn<>'' and (appoint.del_flag ='' or appoint.del_flag is NULL ) AND refer_appoint is null AND date_format(date_app,'%d-%m-%Y')>=date_format(now(),'%d-%m-%Y')";
		...
		$sql="SELECT DISTINCT referout_no,hn,status_app,refer_appoint,visit_appoint,date_app,placecode_main FROM appoint INNER JOIN total_app ON appoint.placecode=total_app.placecode WHERE hn<>'' and (appoint.del_flag ='' or appoint.del_flag is NULL ) AND visit_appoint is null AND date_format(date_app,'%d-%m-%Y')>=date_format(now(),'%d-%m-%Y')";
